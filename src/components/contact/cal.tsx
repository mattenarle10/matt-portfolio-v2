...
export default function CalInline() {
  ...
  return (
    <div className="w-full">
      {!active ? (
        <div className="w-full">
          <div className="mb-3 text-sm md:text-base font-medium tracking-tight opacity-90">
            Book a Call
          </div>
          <div className="-mx-1">
                ...
                >
                  <div className="flex items-start justify-between gap-3">
                    <div className="flex flex-col">
                      ...
                      <span className="text-[11px] md:text-xs opacity-60 group-hover:opacity-80 transition-opacity">
                        {e.subtitle}
                      </span>
                    </div>
                  </div>
                  <p className="mt-2 text-[11px] md:text-xs opacity-80 leading-snug group-hover:opacity-100 transition-opacity">
                    {e.blurb}
                  </p>
                </button>
              ))}
